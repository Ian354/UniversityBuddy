...
import { ForumTopic } from '@/app/type/types';
import { Card, Button, Badge } from '@/app/ui';
import axios from 'axios';
import dynamic from 'next/dynamic';

const ForumTopicView = dynamic(() => import('./ForumTopic'), { ssr: false });

interface ForumSectionProps {
    universityId: string;
}

const ForumSection: React.FC<ForumSectionProps> = ({ universityId }) => {
    ...
    const categories = ['General', 'Accommodation', 'Student Life', 'Academics', 'Activities'];
    ...
    const fetchTopics = async () => {
        try {
            setLoading(true);
            const response = await axios.get(`${apiUrl}/forum/university/${universityId}/topics`);
    ...
    const handleCreateTopic = async (e: React.FormEvent) => {
        ...
        try {
            await axios.post(
                `${apiUrl}/forum/university/${universityId}/topics`,
                newTopic,
                {
